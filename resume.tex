...
\begin{tabular}{r|p{15.5cm}}
 \parbox{\datebox} \textsc{Nov 2011} & \textbf{CleanLogix LLC \hfill Grand Rapids, MI } \\ \textsc{Present}&\emph{Software Developer / Engineer}
   \\&\small{Programmed in Ruby for a linux embedded device.}
   \\&\small{Nokia Qt graphical user interface toolkit UI design.}  
   \\&\small{Software Requirements Specifications / UML Designer}
 \\\multicolumn{2}{c}{} \\

 \textsc{Nov 2009} & \textbf{Kohl's Department Store \hfill Grandville, MI } \\ \textsc{Jun 2011}&\emph{Advertisement Setter and Warehouse Merchandise Management}
